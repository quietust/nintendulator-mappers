...
static	void	Sync (void)
{
	...
	if (Mapper.Mirror & 1)
	{
		EMU->SetCHR_ROM2(0,(Mapper.CHRH << 3) | Mapper.CHRL0);
		EMU->SetCHR_ROM2(2,(Mapper.CHRH << 3) | Mapper.CHRL0);
		EMU->SetCHR_ROM2(4,(Mapper.CHRH << 3) | Mapper.CHRL0);
		EMU->SetCHR_ROM2(6,(Mapper.CHRH << 3) | Mapper.CHRL0);
	}
	else
	{
		EMU->SetCHR_ROM2(0,(Mapper.CHRH << 3) | Mapper.CHRL0);
		EMU->SetCHR_ROM2(2,(Mapper.CHRH << 3) | Mapper.CHRL1);
		EMU->SetCHR_ROM2(4,(Mapper.CHRH << 3) | Mapper.CHRL2);
		EMU->SetCHR_ROM2(6,(Mapper.CHRH << 3) | Mapper.CHRL3);
	}
...
static	u8 MapperNum = 138;
CTMapperInfo	MapperInfo_138 =
{
	&MapperNum,
	_T("Sachen (SA8259A)"),
	COMPAT_FULL,
